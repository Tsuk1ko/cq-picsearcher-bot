import { sdkVersion } from './sdk_version.mjs';
import { SUPPORT_LANGUAGE_LIST } from './interface.mjs';
import Sign from './sign.mjs';
import { HttpConnection } from './http/http_connection.mjs';
...
export class AbstractClient {
  ...
  formatSignString(params) {
    ...
    const strSign =
      this.profile.httpProfile.reqMethod.toLocaleUpperCase() + this.endpoint + this.path + '?' + strParam.slice(1);
    return strSign;
  }
}
